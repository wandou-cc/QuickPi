...
Quick Pi distributes the following third-party software. The complete license
texts are stored in the `licenses` directory and are included in packaged
applications under `Contents/Resources/Licenses`.

| Component | Version | License | License text |
| --- | --- | --- | --- |
| Pi Coding Agent | 0.82.1 | MIT | `licenses/Pi-LICENSE` |
...
Runtime version pinned by `scripts/package-mac.sh`.
